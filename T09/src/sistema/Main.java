...
public class Main {
    ...
    public static void main(String args[]) throws IOException {
        ...
        do {
            ...
            while (ag.followKnownSolution(Agente.FruitSelection.RANDOM, false) != -1);
        ...
        do {
            ...
            System.out.print(itCounter+1 + ": ");
            while (ag.followKnownSolution(Agente.FruitSelection.ID3, false) != -1);
        ...
        System.out.println("\nIniciando execuções com seleção fuzzy de frutas:\n");
        ...
        do {
            ...
            System.out.print(itCounter+1 + ": ");
            while (ag.followKnownSolution(Agente.FruitSelection.FUZZY, false) != -1);
